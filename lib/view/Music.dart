      ...
      children: [
        InkWell(
          ...
          onTap: ()async => {
            ...
            // Playlist(
            // audios: [
            // for(int i = widget.index; i < widget.musicList.length - widget.index + 1; i++)
            // Audio('${widget.musicList[i].path}'),
          ...
          playpopupController.setIsPlay = true, playpopupController.setIsPopup = true,
          playpopupController.setPopupImage = widget.musicList[widget.index].image!,
          playpopupController.setPopupTitle = widget.musicList[widget.index].title!,
          playpopupController.setPopupName = widget.musicList[widget.index].name!,
